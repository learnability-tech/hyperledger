...
return{
	...
	create_claim: function(req, res){
		console.log(">> create_claim ...2 ");

		var array = req.params.holder.split("-");
		var key = array[0]
		var amt = array[1]
		var personId = array[2]
		var policyNum = array[3]
		var createTime = array[4]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    var request = {
		        ...
		        chaincodeId: 'insurance-app',
		        fcn: 'createClaim',
		        args: [key, amt, createTime, personId,policyNum],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
	...
	},approve_claim: function(req, res){
		console.log(">> approve_claim ...2 ");
		console.log(req.params.holder);
		var array = req.params.holder.split("-");
		var key = array[0]
		var amt = array[1]
		var remark = array[2]
	...
	},reject_claim: function(req, res){
		console.log(">> reject_claim ...2 ");
		console.log(req.params.holder);
		var array = req.params.holder.split("-");
		var key = array[0]
		var remark = array[1]
	...
	},get_claim: function(req, res){
		console.log(">>> get_claim ... 2");
		var fabric_client = new Fabric_Client();
		var key = req.params.id
		console.log(req.params);
		console.log(key);
